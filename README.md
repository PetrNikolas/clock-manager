...
For more detailed guide on AoT's Do's and Don'ts refer to [https://github.com/rangle/angular-2-aot-sandbox](https://github.com/rangle/angular-2-aot-sandbox)
...
* If you're in China
  * check out [https://github.com/cnpm/cnpm](https://github.com/cnpm/cnpm)
...
* Setup SonarQube with the [Sonar Typescript plugin](https://github.com/Pablissimo/SonarTsPlugin#installation) and
the Generic Test Coverage plugin [https://docs.sonarqube.org/display/PLUG/Generic+Test+Coverage](https://docs.sonarqube.org/display/PLUG/Generic+Test+Coverage)
